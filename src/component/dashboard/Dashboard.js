    ...
    render() {
        return (
            <div>
                ...
                <section class="service-section home-4 pt-0 bg-f9 padding-tb">
                    <div class="container">
                ...
                {/* Service Section Start Here  */}
                <section class="service-section home-4 bg-f6 padding-tb">
                ...
                <section class="timeline-section padding-tb">
                    <div class="container">
                        <div class="section-header wow fadeInUp" data-wow-delay="0.3s">
                            <span>Timeline</span>
                        ...
                        <div class="section-wrapper wow fadeInUp" data-wow-delay="0.4s">
                            <div class="timeline-list line-1">
                                <div class="timeline-shape timeline-shape1">
                            ...
                            <div class="timeline-list line-2">
                                <div class="timeline-shape timeline-shape2">
                                    <img src="assets/images/timeline/02.png" alt="timeline-shape"></img>
                                </div>
                                <div class="timeline-shape timeline-shape3">
                                    <img src="assets/images/timeline/02.png" alt="timeline-shape"></img>
                                </div>
                                <div class="row justify-content-center no-gutters">
                                    <div class="col-xl-3 col-sm-6 col-12">
                            ...
                            <div class="timeline-list line-3">
                                <div class="timeline-shape timeline-shape4">
                                    <img src="assets/images/timeline/01.png" alt="timeline-shape"></img>
                                </div>
                                <div class="timeline-shape timeline-shape5">
                                    <img src="assets/images/timeline/01.png" alt="timeline-shape"></img>
                                </div>
                                <div class="row justify-content-center no-gutters">
                                    <div class="col-xl-3 col-sm-6 col-12">
                        ...
                        <div class="section-wrapper wow fadeInUp" data-wow-delay="0.4s">
                            <ul class="tab-lists lab-ul nav justify-content-center" id="myTab" role="tablist">
                                <li class="nav-item tab-list">
                                    <a class="active" id="general-tab" data-toggle="tab" href="index-4.html#general" role="tab" aria-controls="general" aria-selected="true">General</a>
                                </li>
                                <li class="nav-item tab-list">
                ...
                <section class="blog-section home-3 bg-f6 padding-tb">
                    <div class="home-4-shape">
                        <div class="shape">
                            <img src="assets/images/banner/home-4/home-4-shape.png" alt="service-shape"></img>
                        </div>
                                        ...
                                        <div class="post-item-inner">
											...
											Not Could More...</a></h5>
                                                <div class="author-date">
                                                    <a href="index-4.html#" class="date"><i class="icofont-calendar"></i>July 12, 2020</a>
                                                    <a href="index-4.html#" class="admin"><i class="icofont-ui-user"></i>Somrat Islam</a>
                                                </div>
                                                ...
                                                <div class="post-footer">
                                                    <a href="index-4.html#" class="text-btn">Read More<i class="icofont-double-right"></i></a>
                                                    <a href="index-4.html#" class="comments"><i class="icofont-comment"></i><span>2</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
