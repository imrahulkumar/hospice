...
export default class Header extends Component {
    ...
    responseGoogle = response => {
        ...
        localStorage.setItem('currentUser', JSON.stringify(response.profileObj));
                                        ...
                                        {this.state.isUserLoggedIn && (
                                            <div className="userDetails-wrapper">
                                                <div className="details-wrapper">
                                                    ...
                                                    <div className="image">
                                                        <img alt="description" style={{ width: "35px", height: "35px", borderRadius: "50%" }} src={this.state.userDetails.imageUrl} />
                                                        <GoogleLogout
                                                            render={renderProps => (
                                                                <button
                                                                    style={logoutStyle}
